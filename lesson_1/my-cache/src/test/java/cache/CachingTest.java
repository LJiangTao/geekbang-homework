...
import cache.event.TestCacheEntryListener;
...
public class CachingTest {
  ...
  private static final String IN_MEMORY_CACHE_URI = "in-memory://localhost/";
  private static final String REDIS_JEDIS_CACHE_URI = "redis-jedis://localhost:6379/";
  private static final String REDIS_LETTUCE_CACHE_URI = "redis-lettuce://localhost:6379/";

  @Test
  public void testSampleInMemory() {
    CachingProvider cachingProvider = Caching.getCachingProvider();
    CacheManager cacheManager =
        cachingProvider.getCacheManager(URI.create(IN_MEMORY_CACHE_URI), null);
    // configure the cache
  ...
  private void baseTestRedis(String redis_lettuce_cache_uri) {
    CachingProvider cachingProvider = Caching.getCachingProvider();
    CacheManager cacheManager =
        cachingProvider.getCacheManager(URI.create(redis_lettuce_cache_uri), null);
    // configure the cache
    MutableConfiguration<String, Integer> config =
