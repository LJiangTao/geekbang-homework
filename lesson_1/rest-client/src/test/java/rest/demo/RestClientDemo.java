...
//        System.out.println(content);
    ...
    public void doPOST() {
        ...
        formData.put("test_1", Collections.singletonList("test_1"));
        formData.put("test_2", Collections.singletonList("test_2"));
        formData.put("test_3", Collections.singletonList("test_3"));
        formData.put("test_4", Collections.singletonList("test_4"));

        Entity<Form> formEntity = Entity.form(formData);

        Response response = client
                .target("http://127.0.0.1:8080/post")      // WebTarget
                .request() // Invocation.Builder
